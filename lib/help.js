const helpText =
    `This API enables cross-origin requests to escape. This fork will add a "Discordbot/2.0" user-agent header if it is given an authorization header that starts with "Bot".
